...
hdulist=fits.open('/Volumes/sting_1/snap99_result/snap99_140304/image_140304_p1_64src_10.fits')
...
#src = np.array([[-0.000344564,	0.000394416]]) # (2)
...
hdulist2=fits.open('/Volumes/sting_1/snap99_result/snap99_140304/critical_140304_p1_64NN.fits')
...
hdulist3=fits.open('/Volumes/sting_1/snap99_result/snap99_140304/caustics_140304_p1_64NN.fits')
...
plt.scatter(-1*src[0][0],-1*src[0][1],marker='d',edgecolor='k',color='g',s=120)
plt.xlim(-2.5,2.5)
plt.ylim(-2.5,2.5)

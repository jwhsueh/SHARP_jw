...
#photometry
B_mag = groupcat.loadSubhalos(basePath,ssNumber, fields = ['SubhaloStellarPhotometrics'])[:,1]
...
catalog.write('# [10]: photometry B-band \n')
catalog.write('# [11]: photometry V-band \n')

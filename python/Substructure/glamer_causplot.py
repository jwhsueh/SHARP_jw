...
caus=np.loadtxt('/Volumes/sting_1/snap99_128704/caustic_128704_p3.txt')
...
src_pt=np.loadtxt('/Volumes/sting_1/snap99_128704/128704_p3_app_src.dat')
...
plt.scatter(src_pt[0,0],src_pt[0,1],marker='.',s=1,color='r')

...
output_name = '_test/'+str(subID)+'_p'+str(proj)+'_'+NN+'_Rcusp.txt' # no sub
output_name = '_test/'+str(subID)+'_p'+str(proj)+'sub_'+NN+'_Rcusp.txt' # w/ sub
...
drop=0
drop_file='_test/'+str(subID)+'_p'+str(proj)+'_'+NN+'_drop.txt'
drop_log=open(filepath+drop_file,'a+')
drop_log=open(filepath+drop_file,'a+')

for i in range(n_src):
	print "# "+str(i)+" source:"
	filename='_test/image_'+str(subID)+'_p'+str(proj)+'_'+NN+'src_'+str(i)+'.fits' # no sub
	filename='_test/image_'+str(subID)+'_p'+str(proj)+'sub_'+NN+'src_'+str(i)+'.fits' # w/ sub

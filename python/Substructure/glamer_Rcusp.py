...
sn3_path = '/Volumes/sting_1/snap99_result/snap99_222/' ##anaSIE
...
#phi1_s = phi1_s
Rfold_s[phi1_s<31] = Rfold_s[phi1_s<31]/2
...
#np.savetxt('../../data/glamer/snap99_elp_cusp_sig.txt',prob_sig)
...
#np.savetxt('../../data/glamer/snap99_elp_fold_sig.txt',prob_sig)
...
plt.text(6,0.85,'Particle SIE',fontsize=14)
#plt.text(42,0.85,'Particle SIE',fontsize=14)
...
#plt.show()
plt.savefig('../../data/glamer/siepar_fold.png',bbox_inches='tight')

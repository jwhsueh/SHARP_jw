...
fig, ((ax11,ax22,ax33),(ax1,ax2,ax3)) = plt.subplots(2,3,sharey=True,figsize=(6,6))
...
ax11.scatter(phi0_3,np.abs(rcusp_3),color='k',marker='o',label='e = 0.38')
ax11.scatter(phi0_2,np.abs(rcusp_2),color='r',marker='o')
ax11.scatter(phi0,np.abs(rcusp),color='b',marker='o')
ax11.set_ylim(0,0.7)
ax11.set_xlim(40,140)

ax1.scatter(phi1_3,np.abs(rfold_3),color='k',marker='o',label='e = 0.38')
ax1.scatter(phi1_2,np.abs(rfold_2),color='r',marker='o')
ax1.scatter(phi1,np.abs(rfold),color='b',marker='o')
ax1.set_ylim(0,0.7)
ax1.set_xlim(0,60)
#plt.legend(loc=2,scatterpoints=1)
#ax1.get_legend()

tab = np.loadtxt('../../models/snap99_179899/179899_d2_area15_rcusp.txt')
tab2 = np.loadtxt('../../models/snap99_179899/179899_d2_area25_rcusp.txt')
tab3 = np.loadtxt('../../models/snap99_179899/179899_d2_area35_rcusp.txt')
...
ax22.scatter(phi0_3,np.abs(rcusp_3),color='k',marker='o',label='e = 0.38')
ax22.scatter(phi0_2,np.abs(rcusp_2),color='r',marker='o')
ax22.scatter(phi0,np.abs(rcusp),color='b',marker='o')
ax22.set_ylim(0,0.7)
ax22.set_xlim(40,140)

ax2.scatter(phi1_3,np.abs(rfold_3),color='k',marker='o',label='e = 0.28')
ax2.scatter(phi1_2,np.abs(rfold_2),color='r',marker='o')
ax2.scatter(phi1,np.abs(rfold),color='b',marker='o')
ax2.set_ylim(0,0.7)
ax2.set_xlim(0,60)
#plt.legend(loc=2,scatterpoints=1)
...
fig.text(0.06,0.25,'|Rfold|',va='center',rotation='vertical')
fig.text(0.06,0.75,'|Rcusp|',va='center',rotation='vertical')
fig.text(0.5,0.03,'phi 1',ha='center')
fig.text(0.5,0.48,'delta phi',ha='center')

fig.text(0.17,0.85,'e=0.38',ha='center')
fig.text(0.44,0.85,'e=0.28',ha='center')

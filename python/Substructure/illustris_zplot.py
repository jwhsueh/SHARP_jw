...
file0 = basePath+'snapshot'+ssNumber[0]+'_three.dat'
file1 = basePath+'snapshot'+ssNumber[1]+'_three.dat'
file2 = basePath+'snapshot'+ssNumber[2]+'_three.dat'
...
z1['mor_hist'] = z1.morphology/z0.All
z2['mor_hist'] = z2.morphology/z0.All

z0['disk_hist'] = z0.disk_star/z0.All
z1['disk_hist'] = z1.disk_star/z0.All
z2['disk_hist'] = z2.disk_star/z0.All

z0['bulge_hist'] = z0.bulge_star/z0.All
z1['bulge_hist'] = z1.bulge_star/z0.All
z2['bulge_hist'] = z2.bulge_star/z0.All

#print z0

plt.plot(z0.R_E,z0.mor_hist,color='k',label = 'z='+str(redshift[0]),drawstyle='steps',linestyle = 'dashdot')
plt.plot(z0.R_E,z1.mor_hist,'b',label = 'z='+str(redshift[1]),drawstyle='steps',linestyle = 'dashed')
plt.plot(z0.R_E,z2.mor_hist,'r',label = 'z='+str(redshift[2]),drawstyle='steps')
...
plt.ylim(0,0.2)
#plt.show()
plt.savefig('./illustris_cross/redshift_evo_hist_SB.png',bbox_inches='tight')
'''
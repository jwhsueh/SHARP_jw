...
file0_all = basePath+'snapshot'+ssNumber[0]+'st_hist_all2.dat'
file1_all = basePath+'snapshot'+ssNumber[1]+'st_hist_all2.dat'
file2_all = basePath+'snapshot'+ssNumber[2]+'st_hist_all2.dat'
'''
## scatter plot
...
bin = z0_tot.log_stellar_mass[1]-z0_tot.log_stellar_mass[0]
print bin
...
#plt.plot(z0_tot.log_stellar_mass,z0_tot.bulge_hist,color='k',label = 'z='+str(redshift[0]),drawstyle='steps',linestyle = 'dashdot')
#plt.plot(z0_tot.log_stellar_mass,z1_tot.bulge_hist,'b',label = 'z='+str(redshift[1]),drawstyle='steps',linestyle = 'dashed')
#plt.plot(z0_tot.log_stellar_mass,z2_tot.bulge_hist,'r',label = 'z='+str(redshift[2]),drawstyle='steps')

#plt.plot(z0.log_stellar_mass,z0.bulge_star/bin,color='k',label = 'z='+str(redshift[0])+' central',drawstyle='steps')
plt.plot(z0_tot.log_stellar_mass,z0_tot.bulge_star/bin,color='k',label = 'z='+str(redshift[0])+' total',drawstyle='steps',linestyle = 'dashed')
#plt.plot(z1.log_stellar_mass,z1.bulge_star/bin,color='b',label = 'z='+str(redshift[1])+' central',drawstyle='steps')
plt.plot(z1_tot.log_stellar_mass,z1_tot.bulge_star/bin,color='b',label = 'z='+str(redshift[1])+' total',drawstyle='steps',linestyle = 'dashed')
#plt.plot(z2.log_stellar_mass,z2.bulge_star/bin,color='r',label = 'z='+str(redshift[2])+' central',drawstyle='steps')
plt.plot(z2_tot.log_stellar_mass,z2_tot.bulge_star/bin,color='r',label = 'z='+str(redshift[2])+' total',drawstyle='steps',linestyle = 'dashed')


plt.xlabel('log(stellar mass)')
plt.ylabel('galaxy count / bin')
#plt.ylabel('Disk system fraction')
#plt.title('Central + Satellite')
...
plt.savefig('../../data/illustris_1/compare/zEvo_bins_bf2.png',bbox_inches='tight')

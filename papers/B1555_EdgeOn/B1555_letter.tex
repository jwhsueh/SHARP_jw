...
perturbation in the mass model.  \textbf{Although a constraint on the disc mass from photometry is currently not avaliable due to the low signal-to-noise ratio in AO imaging and the lack of redshift information, our model indicates that the flux-ratio anomalies in B1555+375, at least, have a strong link to the presence of its edge-on disc. } Such

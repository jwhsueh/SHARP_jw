...
have a different origin than substructure. \textbf{ISM and microlensing both can produce flux anomalies in lens systems, but the effects from ISM show strong frequency dependence and observing in radio band can avoid microlensing from star-size objects \citep{KD04}. These origins are ruled out among known radio loud flux anomlous systems support the detection of substructures. }[OTHER POSSIBLE ORIGONS--SIMONA]
%

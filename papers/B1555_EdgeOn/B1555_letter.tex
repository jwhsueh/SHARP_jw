...
[WHY NO EXTERNAL SHEAR?---WITH ONLY THE RADIO POSITIONS AND FLUXES AS
CONSTRAINTS, ADDING SHEAR WOULD MAKE THE PROBLEM EVEN MORE UNDERCONSTRAINED]
...
Comparision between radio and model-predicted lensed image positions. Observation data quoted from Table 2 in \citet{Marlow99}. Position offsets are in unit of arcsec. Both SIE+expdisk and 2-SIE lens model-predicted positions well match to the radio observation.
...
component \citep{Marlow99,Xu14} fail to reproduce the fluxes

...
\citep[SHARP;][Fassnacht et al., in prep]{CLASS1}.
...
strength $\Gamma_s=0.002$), when modelled with the pixelized technique
of \citet{V09}.
...
mass distributions. Indeed \citet{SHARP12} showned that high
...
lens modelling.  With a bulge plus an edge-on disk, our models produce

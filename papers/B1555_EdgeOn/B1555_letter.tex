...
perturbation in the mass model.  \textbf{Although a constraint on the disc mass from photometry is currently not available due to the low signal-to-noise ratio in the AO imaging and the lack of redshift information, our model indicates that the flux-ratio anomaly in B1555+375 has a strong link to the presence of an edge-on disc. } Such

...
\author[Hsueh et al.]{J.-W. Hsueh,$^{1}$\thanks{E-mail: jwhsueh@ucdavis.edu} C. D. Fassnacht,$^{1}$ S. Vegetti,$^{2}$  J. McKean,$^{3,4}$ C. Spingola,$^{4}$ M. W. Auger,$^{5}$

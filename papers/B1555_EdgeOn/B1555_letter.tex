...
The positions are all in agreement, and the flux ratios are consistent at the $2\sigma$ level, with excellent agreement now obtained for the two merging images A and B. The remaining differences in fluxes may due to the real lensed source being slightly extended rather than the point source that we used in our model. The model requires that the \textbf{ExpDisc component makes up about 15 per cent of the total projected mass within the Einstein radius (1.7~kpc for an assumed lens redshift of $z_l = 1$).  In this central region of an edge-on spiral galaxy, the baryonic mass can be a significant component of the total projected mass. The sample of 16 edge-on disks from SDSS found in the SWELLS survey shows that the disc can contribute more than 20 per cent mass in the Einstein radius \citep{swells1,swells3}.} 

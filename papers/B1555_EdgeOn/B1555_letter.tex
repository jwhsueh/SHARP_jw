...
%   & (SIE) & (ExpDisc)\\
\hline
$\Delta$RA	& $-0.177 \pm 0.005$		& $-0.162$ \textit{(fixed)}\\
$\Delta$Dec	& $-0.205 \pm 0.005$		& $-0.206$ \textit{(fixed)} \\
$b$ 			& $0.18 \pm 0.01$  		& ...  \\
$\kappa_0$ & ... &$0.27 \pm 0.01$\\
$e$	  		& $0.25 \pm 0.01$			& $0.83$ \textit{(fixed)} \\
$\theta$ 		& $4.9 \pm 0.6$			& $8.0$ \textit{(fixed)}	 \\
$R_s$			& ...  						& $0.24 \pm 0.01$	 \\
\hline
\label{tab:model}
\end{tabular}

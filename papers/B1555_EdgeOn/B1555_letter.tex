...
%\end{minipage}
\medskip
Comparision between radio and model-predicted lensed image positions. Observation data quoted from Table 2 in \citet{Marlow}. Position offsets are in unit of arcsec. Both SIE+expdisk and 2-SIE lens models predict the same lens image positions.
...
\hline
	& \multicolumn{2}{c}{MERLIN} & \multicolumn{3}{c}{Model}\\

...
model_path = '/Users/jwhsueh/Documents/SHARP_jw/models/snap99_269350/'
lens_path = '/Volumes/sting_1/snap99_269350/'
out_path = '/Users/jwhsueh/Documents/SHARP_jw/datas/sub_gravlens/snap99_edge/'

sublist='269350_p1'
subid='269350'
n_src = 9
imsize = 256
physize = 4.71E-04 # deg
physize = physize*3600 # arcsec

rcusp_file = open(out_path+sublist+'_sie_rcusp_sh.txt','w')
ast_file = open(out_path+sublist+'_sie_ast_sh.txt','w')
...
for i in range(n_src):
	...
	## pick up 3 img system
	if np.abs(tab[3][0])>physize/2:
		print "** 3 img system"
		...
		opt_src.write(str(tab[3])[1:-1]+' 1.368  1000 1000  0.0 0.0 \n')
	...
	opt_out = commands.getstatusoutput('./lensmodel opt_269350_gravlens.input')
	...
	#if np.abs(img_x[0])>physize/2:
	#	## go into 3 img opt fit
	#	chi2=1000
	#	print '## drop this'
